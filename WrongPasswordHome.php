    ...
    <body>
        <div>
            ...
            <form class="title" action="Home.php" onsubmit="return validate();" method="POST">
                ...
                <input type="text"placeholder="someone@email.com" name="email"id="userEmail" ><p id="emailcomment"></p>
                <br>
                <label class="col-md-2">Password</label>
                <input type="password" placeholder="password"name="password" id="userPass" ><p id="passwordcomment">Wrong Password</p>
                <br>
