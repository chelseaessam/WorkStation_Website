    ...
    <body>
        <div>
            ...
            <!--Content!-->
                ...
                <!-- registeration form!-->
            <form class="title" action="Register.php" method="POST" onsubmit="return validate();">
                <label class="col-md-2" >Email</label>
                <input type="text" name="email"placeholder="someone@email.com" id="userEmail"><p id="emailcomment">This email is already registered</p>
                <br>
                <label class="col-md-2">Password</label>
                <input type="password" name="password"placeholder="password" id="userPass"><p id="passwordcomment"></p>
                <br>
                <button type="submit"class=" btn btn-secondary col-md-2" id="mybutton">Register</button>
            </form>
        ...
        <script type="text/javascript">
            ...
            //checking if email is valid ie contains either (@gmail.com)or(@hotmail.com)
               if($("#userEmail").val()!='')
               {
               ...
               //checking if password is more than 8 characters
